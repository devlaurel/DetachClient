...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public Vec3 getLook(float partialTicks) {
        EventLook eventLook = new EventLook(this.rotationPitch, this.rotationYaw);
        Client.INSTANCE.getEventBus().publish(eventLook);
        return this.getVectorForRotation(eventLook.getPitch(), eventLook.getYaw());
    }
}
